...
function Boxes_competitor.endGame(msg) 
  ...
  message:draw_over_surface(screen_competitor, msg)
  score:draw_over_surface(screen_competitor, "Score: " .. Boxes_competitor.current_score)
  screen:copyfrom(screen_competitor,nil,{x=640,y=0})
  gfx.update()
end
